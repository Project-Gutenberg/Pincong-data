---
layout: default
Lastmod: 2020-06-10T16:32:09.629513+00:00
date: 2020-06-02T00:00:00.000Z
title: "[转载]Shadowsocks 笔记 (一些翻墙软件的历史)"
author: "marxist"
tags: [历史,V2Ray,shadowsocks,翻墙,SSR,互联网]
---
...
[https://raw.githubusercontent.com/JadaGates/ShadowsocksBio/master/image/cwpostss.png]( "https://raw.githubusercontent.com/JadaGates/ShadowsocksBio/master/image/cwpostss.png")[https://raw.githubusercontent.com/JadaGates/ShadowsocksBio/master/image/cwpostss.png]( "https://raw.githubusercontent.com/JadaGates/ShadowsocksBio/master/image/cwpostss.png")  
...
[https://raw.githubusercontent.com/JadaGates/ShadowsocksBio/master/image/cw.png]( "https://raw.githubusercontent.com/JadaGates/ShadowsocksBio/master/image/cw.png")  
至此，SS原作者退出。  
...
最初的 Surge 定位于网络调试工具，作者本人写了一个 SS module 实现了 SS，也许作者本人的想法并不是翻墙，所以该 module 从开始就是一个黑箱，且长时间没有支持V2Ray等新型协议，直至2019年和2020年才分别加入了对V2Ray与Trojan的支持。另外，Surge于2019年起添加了对其自研闭源协议Snell的支持，并于2020年发布了该协议的v2版本。无心栽柳柳成荫，Surge 可以在 iOS 端实现全局代理，并且自开始稳定性就非常好，68的售价并没有挡住人们热情的购买力，但此时的 Surge 仍然是相对小众的。  
...
[https://raw.githubusercontent.com/JadaGates/ShadowsocksBio/master/image/surge1.png]( "https://raw.githubusercontent.com/JadaGates/ShadowsocksBio/master/image/surge1.png")  
...
与Surge不同，小火箭的初衷就是为了翻墙，所以作者直接就内置了各种翻墙协议，通过UI界面非常容易添加和修改，作者也针对国内的环境开发出了场景模式，按需求连接，服务器订阅等模式，同时作者在\[Telegram\](https://telegram/ShadowrocketApp)上创建了群组，用户之间的交流以及开发者的反馈速度很快。  
  
!\[shadowrocket\](image/shadowrocket.png\[/img\]  
...
!\[Quantumult\](image/Quantumult.png\[/img\]  
...
搬瓦工的机器可以在控制面板 ---> install new os ---> centos-7-x86\_64-bbr，快速更换系统，注意备份服务器上的数据。  
  
[https://raw.githubusercontent.com/JadaGates/ShadowsocksBio/master/image/newOS.png]( "https://raw.githubusercontent.com/JadaGates/ShadowsocksBio/master/image/newOS.png")  
...
!\[Snipaste\_2018-09-12\_09-12-18\](image/Snipaste\_2018-09-12\_09-12-18.png\[/img\]  
...
[https://raw.githubusercontent.com/JadaGates/ShadowsocksBio/master/image/Snipaste\_2018-09-12\_09-22-01.png]( "https://raw.githubusercontent.com/JadaGates/ShadowsocksBio/master/image/Snipaste_2018-09-12_09-22-01.png")  
  
obfs可以直接在SS的服务器编辑页面修改参数  
  
[https://raw.githubusercontent.com/JadaGates/ShadowsocksBio/master/image/Snipaste\_2018-09-12\_09-24-32.png]( "https://raw.githubusercontent.com/JadaGates/ShadowsocksBio/master/image/Snipaste_2018-09-12_09-24-32.png")  
...
[https://raw.githubusercontent.com/JadaGates/ShadowsocksBio/master/image/macOsNG.png]( "https://raw.githubusercontent.com/JadaGates/ShadowsocksBio/master/image/macOsNG.png")  
  
\- \[Shadowsocks-NG 下载地址\](https://github.com/shadowsocks/ShadowsocksX-NG/releases)  
  
\#### ClashX  
  
最近出现了一个新的类Surge软件，ClashX，目前还在快速迭代期之中，兼容 Surge 的 config 文件，基本上对其稍作修改便可以导入 ClashX 中使用。可以去官方\[ Telegram 群\](telegram/clash\_discuss)参与讨论  
  
类Surge软件的核心都在于config文件，在SS网络分流的基础上，对不同的流量产生不同的行为，可以实现指定网址代理，广告屏蔽等效果，自由度更高。  
  
[https://raw.githubusercontent.com/JadaGates/ShadowsocksBio/master/image/clashX.png]( "https://raw.githubusercontent.com/JadaGates/ShadowsocksBio/master/image/clashX.png")  
...
[https://raw.githubusercontent.com/JadaGates/ShadowsocksBio/master/image/ass.png]( "https://raw.githubusercontent.com/JadaGates/ShadowsocksBio/master/image/ass.png")  
...
### 品葱用户 **posclegom** 评论于 2020-06-05
        
我实在是搞不明白，斗法都斗成这样了，为什么还不砍断海底光缆一了百了？究竟当局和翻墙者玩这种猫捉老鼠的把戏究竟图的是什么？
        


            
### 品葱用户 **posclegom** 评论于 2020-06-06
        
别跟我说什么物理断网会“严重影响经济从而影响政权稳定性”云云：  
  
